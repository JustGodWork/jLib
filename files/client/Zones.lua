...
function Zone:setCallBack(callback)
    self.callback = callback
end

---@param callback function
function Zone:start(callback)
...
---@param timer number
function Zone:setTimer(timer)
    self.timer = timer
end

---@param timer number
function Zone:addTimer(timer)
    Wait(timer)
end

---@return number
function Zone:getTimer()
    return self.timer
end
...
function Zone:isPlayerInRadius(radius, callback, allowVehicle, onlyInVehicle)
...
function Zone:radiusEvents(radius, onEnter, onLeave)
...
---@param key string
---@param value any
function Zone:setData(key, value)
    self.data[key] = value
end

---@param key string
function Zone:getData(key)
...
function Zone:setCoords(coords)
    self.coords = coords
end
